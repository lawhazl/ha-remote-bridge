...
API_URL = "{proto}://{host}:{port}/api/ha_bridge/discovery"
...
class EndpointMissing(exceptions.HomeAssistantError):
    """Error to indicate the discovery endpoint is not present on the host."""


class VersionMismatch(exceptions.HomeAssistantError):
